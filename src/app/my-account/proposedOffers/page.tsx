...
const fetchOffers = async (token: string): Promise<Offer[]> => {
    const res = await fetch('http://localhost:8000/api/offers/getProposedOffers', {
        method: 'GET',
        headers: {
...
export default function ProposedOffersPage() {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-12 px-4">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8">
                <h1 className="text-3xl font-bold text-blue-700 mb-8 text-center flex items-center justify-center gap-2">
                    <FaTag className="text-blue-500" /> Proposed Offers
                </h1>
                {offers.length === 0 ? (
