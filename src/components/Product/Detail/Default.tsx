                        ...
                        <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                            ...
                            <div className="list-action mt-6">
                                ...
                                <div className="button-block mt-5">
                                    <div className="button-main w-full text-center">Buy It Now      ${productMain.originPrice}</div>
                                </div>
                                <div className="button-block mt-5">
                                    <div className="button-main w-full text-center">Rent It Now     ${productMain.originPrice}</div>
                                </div>
                            ...
                            <div className="get-it mt-6 pb-8 border-b border-line">
                                ...
                                <div className="item flex items-center gap-3 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="caption1 text-secondary mt-1">Free shipping on all orders</div>
                                    </div>
                                </div>
                                <div className="item flex items-center gap-3 mt-4">
                                ...
                                <div className="item flex items-center gap-3 mt-4">
                                    ...
                                    <div>
                                        <div className="text-title">7 Days Return</div>
